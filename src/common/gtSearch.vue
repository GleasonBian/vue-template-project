    ...
    <el-row type="flex" justify="center" align="middle" :gutter="20">
      ...
      <el-col :span="7" class="el-col-search" v-if="searchName.box2.show">
        ...
        <el-input
          v-model="keyword2"
          placeholder="请输入"
          v-if="searchName.box2.input && !(ParentPage=='MaterialGoodsRelation')"
          clearable
          style="width:350px"
        ></el-input>
        <el-select
        ...
        <el-cascader
          ...
          :props="props"
          :options="options"
          @active-item-change="getClassHandle"
  ...
  methods: {
    ...
    async suppliesList(limit, offset) {
      ...
      let data = {
        ...
        id: this.keyword4,
        productStatus:
          this.ParentPage == "goodsList" ? "ONLINE" : this.keyword5,
        startTime: this.startTime,
        endTime: this.endTime,
        limit: limit == undefined ? 10 : limit,
        pageNo: offset == undefined ? 1 : offset
    ...
    async buyerFeedbackList(limit, offset) {
      // 反馈
      let data = {};
